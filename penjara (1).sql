...
--
-- Host: 127.0.0.1
-- Generation Time: May 06, 2021 at 10:01 AM
...
--
ALTER TABLE `kunjungan`
  ADD CONSTRAINT `kunjungan_ibfk_1` FOREIGN KEY (`no_ktp`) REFERENCES `pengunjung` (`no_ktp`) ON DELETE NO ACTION ON UPDATE CASCADE,
  ADD CONSTRAINT `kunjungan_ibfk_2` FOREIGN KEY (`no_tahanan`) REFERENCES `napi` (`no_tahanan`) ON DELETE NO ACTION ON UPDATE CASCADE;

--
-- Constraints for table `napi`
--
ALTER TABLE `napi`
  ADD CONSTRAINT `napi_ibfk_1` FOREIGN KEY (`no_ruangan`) REFERENCES `ruang_lapas` (`no_ruangan`) ON UPDATE CASCADE;

--
-- Constraints for table `pegawai`
--
ALTER TABLE `pegawai`
  ADD CONSTRAINT `pegawai_ibfk_1` FOREIGN KEY (`nama_lapas`) REFERENCES `cabang_lapas` (`nama_lapas`) ON UPDATE CASCADE;

--
-- Constraints for table `pengunjung`
--
ALTER TABLE `pengunjung`
  ADD CONSTRAINT `pengunjung_ibfk_1` FOREIGN KEY (`no_tahanan`) REFERENCES `napi` (`no_tahanan`) ON UPDATE CASCADE;

--
-- Constraints for table `ruang_lapas`
--
ALTER TABLE `ruang_lapas`
  ADD CONSTRAINT `ruang_lapas_ibfk_1` FOREIGN KEY (`nama_lapas`) REFERENCES `cabang_lapas` (`nama_lapas`) ON UPDATE CASCADE;

--
-- Constraints for table `sipir`
--
ALTER TABLE `sipir`
  ADD CONSTRAINT `sipir_ibfk_1` FOREIGN KEY (`no_ruangan`) REFERENCES `ruang_lapas` (`no_ruangan`) ON UPDATE CASCADE;
COMMIT;
